...
plot(clean_project$Time, clean_project$Global_active_power, type = "l", 
...
legend("topright", lwd = 1, bty = "n", col = c("black", "red", "blue"), legend = c("Sub_metering_1", 
	"Sub_metering_2", "Sub_metering_3"))

plot(clean_project$Time, clean_project$Voltage, type = "l", 
	ylab = "Voltage", xlab = "datetime")

plot(clean_project$Time, clean_project$Global_reactive_power, type = "l", 
